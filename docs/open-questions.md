...
| ------ | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----------- |
| TQ-001 | Application session design    | Versioned one-hour HMAC-authenticated cookie; Discord access token only in client memory; current/previous signing-key rotation; add server-side generations only if immediate revocation becomes necessary | M1          | accepted    |
