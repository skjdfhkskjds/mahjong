/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker/worker-configuration.d.ts` (hash: 91a652c07f4437a3d1f1222861a3c149)
// Runtime types generated with workerd@1.20260820.1 2026-08-23
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	APP_MODE: "discord" | "mock";
	SESSION_COOKIE_NAME: "__Host-mahjong_session" | "mahjong_session";
	SESSION_TTL_SECONDS: "3600";
	TABLE_ROOM: DurableObjectNamespace<import("./index").TableRoom>;
	SESSION_SIGNING_KEY?: "mock-mode-only-signing-key-change-before-deployment";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "TableRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_MODE" | "SESSION_COOKIE_NAME" | "SESSION_TTL_SECONDS" | "SESSION_SIGNING_KEY">> {}
}
