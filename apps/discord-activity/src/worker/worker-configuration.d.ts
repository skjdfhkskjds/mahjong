/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker/worker-configuration.d.ts` (hash: 783928faf3dbce81bfb8354da6dd54c1)
...
interface __BaseEnv_Env {
	...
	ACTIVITY_INSTANCE: DurableObjectNamespace<import("./index").ActivityInstance>;
	TABLE_ROOM: DurableObjectNamespace<import("./index").TableRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ActivityInstance" | "TableRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_MODE" | "SESSION_COOKIE_NAME" | "SESSION_TTL_SECONDS" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "DISCORD_BOT_TOKEN" | "SESSION_SIGNING_KEY" | "SESSION_SIGNING_KEY_PREVIOUS">> {}
}
